...
public class MavenDependency extends Dependency {
	...
	public int getArtifactLineNum() {
		return artifactLineNum;
	}

	public void setArtifactLineNum(int arttifactLineNum) {
	...
	public String toString() {
		return "Dependency {groupId=" + this.getGroupId() + ", artifactId=" + this.getArtifactId() + ", version="
				+ this.getVersion() + ", artifactLineNum=" + artifactLineNum + ", groupLineNum=" + groupLineNum
				+ ", versionLineNum=" + versionLineNum + "}";
	}
